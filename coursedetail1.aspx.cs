...
public partial class coursedetail1 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
            string course = (string)Session["MyVariable0"];
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                command1.Parameters.AddWithValue("@MyVariable0", course);
                name = command1.ExecuteScalar().ToString();


                SqlCommand command2 = new SqlCommand(query2, connection);
                command2.Parameters.AddWithValue("@username", username);
                command2.Parameters.AddWithValue("@MyVariable0", course);
                ...
                command4.Parameters.AddWithValue("@MyVariable0", course);
                ...
                command5.Parameters.AddWithValue("@MyVariable0", course);
